...
class TestImport:
    ...
    def test_records_body_no_longer_accepted(self, mock_svc, mock_get_user, mock_verify, client):
        """CR #64: records[] body shape is gone. POST without 'upcs' → 400."""
        ...
        assert "Missing 'upcs'" in resp.get_json()['error']
