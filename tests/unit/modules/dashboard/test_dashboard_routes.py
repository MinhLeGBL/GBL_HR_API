...
so auth mocking must patch app.modules.auth.routes.auth_service.
"""
import json
import pytest
...
class TestGetDashboardConfig:
    ...
    @patch('app.modules.dashboard.routes.dashboard_service.get_dashboard_config')
...
class TestSaveDashboardConfig:
    ...
    @patch('app.modules.dashboard.routes.dashboard_service.save_dashboard_config')
    @patch('app.modules.auth.routes.auth_service.get_user_by_sid')
    @patch('app.modules.auth.routes.auth_service.verify_token')
...
class TestGetWidgetData:
    ...
    @patch('app.modules.dashboard.routes.dashboard_service.get_widget_data')
    @patch('app.modules.auth.routes.auth_service.get_user_by_sid')
    @patch('app.modules.auth.routes.auth_service.verify_token')
