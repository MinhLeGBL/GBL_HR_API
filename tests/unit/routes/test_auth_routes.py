...
class TestLogin:
    ...
    @patch('app.api.v1.routes.auth_routes.auth_service.authenticate')
...
class TestRefreshToken:
    ...
    @patch('app.api.v1.routes.auth_routes.auth_service.refresh_access_token')
...
class TestChangePassword:
    ...
    @patch('app.api.v1.routes.auth_routes.auth_service.change_password')
    @patch('app.api.v1.routes.auth_routes.auth_service.get_user_by_sid')
    @patch('app.api.v1.routes.auth_routes.auth_service.verify_token')
...
class TestRegister:
    ...
    @patch('app.api.v1.routes.auth_routes.auth_service.create_user')
    @patch('app.api.v1.routes.auth_routes.auth_service.get_user_by_sid')
    @patch('app.api.v1.routes.auth_routes.auth_service.verify_token')
...
class TestGetAllUsers:
    ...
    @patch('app.api.v1.routes.auth_routes.auth_service.get_all_users')
    @patch('app.api.v1.routes.auth_routes.auth_service.get_user_by_sid')
    @patch('app.api.v1.routes.auth_routes.auth_service.verify_token')
...
class TestGetRoles:
    ...
    @patch('app.api.v1.routes.auth_routes.auth_service.get_roles')
    @patch('app.api.v1.routes.auth_routes.auth_service.get_user_by_sid')
    @patch('app.api.v1.routes.auth_routes.auth_service.verify_token')
