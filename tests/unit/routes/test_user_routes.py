...
so the auth_service to patch is at app.api.v1.routes.user_routes.auth_service.
"""
import json
import pytest
...
class TestGetAllUsers:
    ...
    @patch('app.api.v1.routes.user_routes.auth_service.get_all_users')
    @patch('app.api.v1.routes.user_routes.auth_service.get_user_by_sid')
    @patch('app.api.v1.routes.user_routes.auth_service.verify_token')
...
class TestCreateUser:
    ...
    @patch('app.api.v1.routes.user_routes.auth_service.create_user')
    @patch('app.api.v1.routes.user_routes.auth_service.get_user_by_sid')
    @patch('app.api.v1.routes.user_routes.auth_service.verify_token')
...
class TestUpdateUser:
    ...
    @patch('app.api.v1.routes.user_routes.auth_service.update_user')
    @patch('app.api.v1.routes.user_routes.auth_service.get_user_by_sid')
    @patch('app.api.v1.routes.user_routes.auth_service.verify_token')
...
class TestDeleteUser:
    ...
    @patch('app.api.v1.routes.user_routes.auth_service.delete_user')
    @patch('app.api.v1.routes.user_routes.auth_service.get_user_by_sid')
    @patch('app.api.v1.routes.user_routes.auth_service.verify_token')
