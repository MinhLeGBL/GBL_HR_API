...
def auth_service():
    ...
    with patch('app.services.auth_service.JWT_CONFIG', _JWT_CFG):
...
class TestAuthenticate:
    @patch('app.services.auth_service.get_postgres_connection')
    def test_success(self, mock_get_conn, auth_service):
        ...
        with patch('app.services.permission_service.PermissionService') as MockPermSvc:
